 ...
 * @file
 *
 * 	iProjectWebProjectStatuses main view row html function
 *
 * 	@see iProjectWebProjectStatuses::getMainView()
...
/**
 * 	Displays a iProjectWebProjectStatuses main view record
 *
 * @param object $view
 * 	the iProjectWebProjectStatuses main view object
 * @param object $obj
 * 	a db object
 * @param int $i
 * 	record index
 ...
 * 	request data
 */
function getProjectStatusesMainViewRow($view, $obj, $i, $map) { ?>
  <tr class='ufohighlight <?php iProjectWebIHTML::getTrSwapClassName($i);?>'>
    ...
    <td>
      <a onclick='redirect({m:"show", oid:"<?php echo $obj->get('id');?>", t:"ProjectStatuses"})'>
