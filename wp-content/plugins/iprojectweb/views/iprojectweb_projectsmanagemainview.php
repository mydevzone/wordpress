 ...
 * @file
 *
 * 	iProjectWebProjects manageMain view html template
 *
    ...
    <div class='viewtable'>
      <table class='vtable'>
          ...
          <th>
            <?php iProjectWebIHTML::getColumnHeader(
              array(
                 'view' => $obj,
                 'field' => "Description",
                 'label' => IPROJECTWEB_AvailableProjects,
              )
            );?>
          </th>
        </tr>
        <?php iProjectWebLayout::getRows(
          ...
          'iProjectWebProjects',
          $obj,
          'iprojectweb_projectsmanagemainviewrow.php',
          'getProjectsManageMainViewRow',
          $viewmap
        );?>
      </table>
    </div>
