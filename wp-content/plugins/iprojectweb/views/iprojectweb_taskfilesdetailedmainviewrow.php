 ...
 * @file
 *
 * 	iProjectWebTaskFiles detailedMain view row html function
 *
 * 	@see iProjectWebTaskFiles::getDetailedMainView()
...
/**
 * 	Displays a iProjectWebTaskFiles detailedMain view record
 *
 * @param object $view
 * 	the iProjectWebTaskFiles detailedMain view object
 * @param object $obj
 * 	a db object
 * @param int $i
 * 	record index
 ...
 * 	request data
 */
function getTaskFilesDetailedMainViewRow($view, $obj, $i, $map) {
  ...
  <tr class='ufohighlight <?php iProjectWebIHTML::getTrSwapClassName($i);?>'>
    ...
    <td>
      <a onclick='redirect({m:"show", oid:"<?php echo $obj->get('id');?>", t:"TaskFiles"})'>
