 ...
 * @file
 *
 * 	iProjectWebRiskProbabilities main view row html function
 *
 * 	@see iProjectWebRiskProbabilities::getMainView()
...
/**
 * 	Displays a iProjectWebRiskProbabilities main view record
 *
 * @param object $view
 * 	the iProjectWebRiskProbabilities main view object
 * @param object $obj
 * 	a db object
 * @param int $i
 * 	record index
 ...
 * 	request data
 */
function getRiskProbabilitiesMainViewRow($view, $obj, $i, $map) { ?>
  <tr class='ufohighlight <?php iProjectWebIHTML::getTrSwapClassName($i);?>'>
    ...
    <td>
      <a onclick='redirect({m:"show", oid:"<?php echo $obj->get('id');?>", t:"RiskProbabilities"})'>
