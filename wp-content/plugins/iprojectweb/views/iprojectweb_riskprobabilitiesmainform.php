 ...
 * @file
 *
 * 	iProjectWebRiskProbabilities main form html template
 *
 * 	@see iProjectWebRiskProbabilities::getMainForm()
 */
...
echo iProjectWebUtils::getTypeFormDescription($obj->getId(), 'RiskProbabilities');
