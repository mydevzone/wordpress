 ...
 * @file
 *
 * 	iProjectWebTaskFiles main view row html function
 *
...
/**
 * 	Displays a iProjectWebTaskFiles main view record
 *
 * @param object $view
 * 	the iProjectWebTaskFiles main view object
 * @param object $obj
 * 	a db object
 * @param int $i
 * 	record index
 ...
 * 	request data
 */
function getTaskFilesMainViewRow($view, $obj, $i, $map) {
