 ...
 * @file
 *
 * 	iProjectWebRiskStrategies main view html template
 *
...
?>
  ...
  <div>
    <div id='divRiskStrategiesFilter' class='ufo-filter'>
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_riskstrategiesmainviewrow.php',
          'getRiskStrategiesMainViewRow',
          $viewmap
        );?>
      </table>
    </div>
