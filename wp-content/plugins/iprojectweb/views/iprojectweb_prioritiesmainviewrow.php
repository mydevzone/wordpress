 ...
 * @file
 *
 * 	iProjectWebPriorities main view row html function
 *
 * 	@see iProjectWebPriorities::getMainView()
...
/**
 * 	Displays a iProjectWebPriorities main view record
 *
 * @param object $view
 * 	the iProjectWebPriorities main view object
 * @param object $obj
 * 	a db object
 * @param int $i
 * 	record index
 ...
 * 	request data
 */
function getPrioritiesMainViewRow($view, $obj, $i, $map) { ?>
  <tr class='ufohighlight <?php iProjectWebIHTML::getTrSwapClassName($i);?>'>
    ...
    <td>
      <a onclick='redirect({m:"show", oid:"<?php echo $obj->get('id');?>", t:"Priorities"})'>
