 ...
 * @file
 *
 * 	iProjectWebTaskTypes main view row html function
 *
...
/**
 * 	Displays a iProjectWebTaskTypes main view record
 *
 * @param object $view
 * 	the iProjectWebTaskTypes main view object
 * @param object $obj
 * 	a db object
 * @param int $i
 * 	record index
 ...
 * 	request data
 */
function getTaskTypesMainViewRow($view, $obj, $i, $map) { ?>
  <tr class='ufohighlight <?php iProjectWebIHTML::getTrSwapClassName($i);?>'>
    ...
    <td>
      <a onclick='redirect({m:"show", oid:"<?php echo $obj->get('id');?>", t:"TaskTypes"})'>
