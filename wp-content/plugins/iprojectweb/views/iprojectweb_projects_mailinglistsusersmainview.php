 ...
 * @file
 *
 * 	iProjectWebProjects_MailingLists UsersMain view html template
 *
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_projects_mailinglistsusersmainviewrow.php',
          'getProjects_MailingListsUsersMainViewRow',
          $viewmap
        );?>
      </table>
    </div>
