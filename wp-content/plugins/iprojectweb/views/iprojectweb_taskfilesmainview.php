 ...
 * @file
 *
 * 	iProjectWebTaskFiles main view html template
 *
 * 	@see iProjectWebTaskFiles ::getMainView()
 */
...
echo iProjectWebUtils::getViewDescriptionLabel(IPROJECTWEB_TaskFiles);
...
?>
  ...
  <div>
    <div id='divTaskFilesFilter' class='ufo-filter'>
      ...
      <div>
        ...
        <div>
          ...
          <div>
            <label for='<?php echo $obj->sId('Tasks');?>'><?php echo IPROJECTWEB_Task;?></label>
            <select id='<?php echo $obj->sId('Tasks');?>' class='ufo-select ufo-filtersign'>
              <?php echo $obj->sList('ref');?>
            </select>
            <?php iProjectWebIHTML::getAS($obj->Tasks);?>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_taskfilesmainviewrow.php',
          'getTaskFilesMainViewRow',
          $viewmap
        );?>
      </table>
    </div>
