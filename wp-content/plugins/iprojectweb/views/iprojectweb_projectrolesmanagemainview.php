 ...
 * @file
 *
 * 	iProjectWebProjectRoles manageMain view html template
 *
    ...
    <div class='viewtable'>
      <table class='vtable'>
          ...
          <th>
            <?php iProjectWebIHTML::getColumnHeader(
              array(
                 'view' => $obj,
                 'field' => "Description",
                 'label' => IPROJECTWEB_AvailableProjectRoles,
              )
            );?>
          </th>
        </tr>
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_projectrolesmanagemainviewrow.php',
          'getProjectRolesManageMainViewRow',
          $viewmap
        );?>
      </table>
    </div>
