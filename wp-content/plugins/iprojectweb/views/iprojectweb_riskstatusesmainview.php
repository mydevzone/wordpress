 ...
 * @file
 *
 * 	iProjectWebRiskStatuses main view html template
 *
...
?>
  ...
  <div>
    <div id='divRiskStatusesFilter' class='ufo-filter'>
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_riskstatusesmainviewrow.php',
          'getRiskStatusesMainViewRow',
          $viewmap
        );?>
      </table>
    </div>
