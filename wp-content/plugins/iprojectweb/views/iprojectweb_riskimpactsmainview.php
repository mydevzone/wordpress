 ...
 * @file
 *
 * 	iProjectWebRiskImpacts main view html template
 *
...
?>
  ...
  <div>
    <div id='divRiskImpactsFilter' class='ufo-filter'>
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_riskimpactsmainviewrow.php',
          'getRiskImpactsMainViewRow',
          $viewmap
        );?>
      </table>
    </div>
