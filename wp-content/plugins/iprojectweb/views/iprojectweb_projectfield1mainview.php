 ...
 * @file
 *
 * 	iProjectWebProjectField1 main view html template
 *
...
?>
  ...
  <div>
    <div id='divProjectField1Filter' class='ufo-filter'>
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_projectfield1mainviewrow.php',
          'getProjectField1MainViewRow',
          $viewmap
        );?>
      </table>
    </div>
