 ...
 * @file
 *
 * 	iProjectWebProjects manageMain view row html function
 *
 * 	@see iProjectWebProjects::getManageMainView()
...
/**
 * 	Displays a iProjectWebProjects manageMain view record
 *
 * @param object $view
 * 	the iProjectWebProjects manageMain view object
 * @param object $obj
 * 	a db object
 * @param int $i
 * 	record index
 ...
 * 	request data
 */
function getProjectsManageMainViewRow($view, $obj, $i, $map) {
