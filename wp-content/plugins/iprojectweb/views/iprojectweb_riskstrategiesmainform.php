 ...
 * @file
 *
 * 	iProjectWebRiskStrategies main form html template
 *
 * 	@see iProjectWebRiskStrategies::getMainForm()
 */
...
echo iProjectWebUtils::getTypeFormDescription($obj->getId(), 'RiskStrategies');
