 ...
 * @file
 *
 * 	iProjectWebProjects_MailingLists ProjectsMain view html template
 *
...
?>
  ...
  <div>
    <div id='divProjects_MailingListsFilter' class='ufo-filter'>
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_projects_mailinglistsprojectsmainviewrow.php',
          'getProjects_MailingListsProjectsMainViewRow',
          $viewmap
        );?>
      </table>
    </div>
