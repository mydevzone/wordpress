 ...
 * @file
 *
 * 	iProjectWebRiskStatuses main form html template
 *
 * 	@see iProjectWebRiskStatuses::getMainForm()
 */
...
echo iProjectWebUtils::getTypeFormDescription($obj->getId(), 'RiskStatuses');
