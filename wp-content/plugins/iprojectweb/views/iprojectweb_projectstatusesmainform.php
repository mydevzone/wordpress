 ...
 * @file
 *
 * 	iProjectWebProjectStatuses main form html template
 *
 * 	@see iProjectWebProjectStatuses::getMainForm()
 */
...
echo iProjectWebUtils::getTypeFormDescription($obj->getId(), 'ProjectStatuses');
