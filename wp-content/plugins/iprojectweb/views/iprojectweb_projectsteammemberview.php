 ...
 * @file
 *
 * 	iProjectWebProjects TeamMember view html template
 *
 * 	@see iProjectWebProjects ::getTeamMemberView()
 */
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          'iProjectWebProjects',
          $obj,
          'iprojectweb_projectsteammemberviewrow.php',
          'getProjectsTeamMemberViewRow',
          $viewmap
        );?>
      </table>
    </div>
