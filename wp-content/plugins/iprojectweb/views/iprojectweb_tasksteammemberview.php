 ...
 * @file
 *
 * 	iProjectWebTasks TeamMember view html template
 *
...
iProjectWebLayout::getFormHeader('ufo-formpage ufo-teammemberview ufo-' . strtolower($obj->type));
echo iProjectWebUtils::getViewDescriptionLabel(IPROJECTWEB_Tasks);
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          'iProjectWebTasks',
          $obj,
          'iprojectweb_tasksteammemberviewrow.php',
          'getTasksTeamMemberViewRow',
          $viewmap
        );?>
      </table>
    </div>
