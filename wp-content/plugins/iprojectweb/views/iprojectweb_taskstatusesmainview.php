 ...
 * @file
 *
 * 	iProjectWebTaskStatuses main view html template
 *
...
?>
  ...
  <div>
    <div id='divTaskStatusesFilter' class='ufo-filter'>
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_taskstatusesmainviewrow.php',
          'getTaskStatusesMainViewRow',
          $viewmap
        );?>
      </table>
    </div>
