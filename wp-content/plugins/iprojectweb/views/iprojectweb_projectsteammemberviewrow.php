 ...
 * @file
 *
 * 	iProjectWebProjects TeamMember view row html function
 *
...
/**
 * 	Displays a iProjectWebProjects TeamMember view record
 *
 * @param object $view
 * 	the iProjectWebProjects TeamMember view object
 * @param object $obj
 * 	a db object
 * @param int $i
 * 	record index
 ...
 * 	request data
 */
function getProjectsTeamMemberViewRow($view, $obj, $i, $map) { ?>
