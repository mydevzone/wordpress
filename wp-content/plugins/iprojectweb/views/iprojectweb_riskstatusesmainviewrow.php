 ...
 * @file
 *
 * 	iProjectWebRiskStatuses main view row html function
 *
 * 	@see iProjectWebRiskStatuses::getMainView()
...
/**
 * 	Displays a iProjectWebRiskStatuses main view record
 *
 * @param object $view
 * 	the iProjectWebRiskStatuses main view object
 * @param object $obj
 * 	a db object
 * @param int $i
 * 	record index
 ...
 * 	request data
 */
function getRiskStatusesMainViewRow($view, $obj, $i, $map) { ?>
  <tr class='ufohighlight <?php iProjectWebIHTML::getTrSwapClassName($i);?>'>
    ...
    <td>
      <a onclick='redirect({m:"show", oid:"<?php echo $obj->get('id');?>", t:"RiskStatuses"})'>
