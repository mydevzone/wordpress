 ...
 * @file
 *
 * 	iProjectWebRiskImpacts main form html template
 *
 * 	@see iProjectWebRiskImpacts::getMainForm()
 */
...
echo iProjectWebUtils::getTypeFormDescription($obj->getId(), 'RiskImpacts');
