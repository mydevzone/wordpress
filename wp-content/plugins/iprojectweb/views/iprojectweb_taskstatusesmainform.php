 ...
 * @file
 *
 * 	iProjectWebTaskStatuses main form html template
 *
 * 	@see iProjectWebTaskStatuses::getMainForm()
 */
...
echo iProjectWebUtils::getTypeFormDescription($obj->getId(), 'TaskStatuses');
