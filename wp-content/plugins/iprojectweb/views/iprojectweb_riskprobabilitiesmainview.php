 ...
 * @file
 *
 * 	iProjectWebRiskProbabilities main view html template
 *
...
?>
  ...
  <div>
    <div id='divRiskProbabilitiesFilter' class='ufo-filter'>
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_riskprobabilitiesmainviewrow.php',
          'getRiskProbabilitiesMainViewRow',
          $viewmap
        );?>
      </table>
    </div>
