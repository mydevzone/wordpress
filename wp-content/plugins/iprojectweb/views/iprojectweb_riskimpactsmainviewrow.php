 ...
 * @file
 *
 * 	iProjectWebRiskImpacts main view row html function
 *
 * 	@see iProjectWebRiskImpacts::getMainView()
...
/**
 * 	Displays a iProjectWebRiskImpacts main view record
 *
 * @param object $view
 * 	the iProjectWebRiskImpacts main view object
 * @param object $obj
 * 	a db object
 * @param int $i
 * 	record index
 ...
 * 	request data
 */
function getRiskImpactsMainViewRow($view, $obj, $i, $map) { ?>
  <tr class='ufohighlight <?php iProjectWebIHTML::getTrSwapClassName($i);?>'>
    ...
    <td>
      <a onclick='redirect({m:"show", oid:"<?php echo $obj->get('id');?>", t:"RiskImpacts"})'>
