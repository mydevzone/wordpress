 ...
 * @file
 *
 * 	iProjectWebRisks manageMain view row html function
 *
...
/**
 * 	Displays a iProjectWebRisks manageMain view record
 *
 * @param object $view
 * 	the iProjectWebRisks manageMain view object
 * @param object $obj
 * 	a db object
 * @param int $i
 * 	record index
 ...
 * 	request data
 */
function getRisksManageMainViewRow($view, $obj, $i, $map) {
