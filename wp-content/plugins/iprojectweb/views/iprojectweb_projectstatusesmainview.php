 ...
 * @file
 *
 * 	iProjectWebProjectStatuses main view html template
 *
...
?>
  ...
  <div>
    <div id='divProjectStatusesFilter' class='ufo-filter'>
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_projectstatusesmainviewrow.php',
          'getProjectStatusesMainViewRow',
          $viewmap
        );?>
      </table>
    </div>
