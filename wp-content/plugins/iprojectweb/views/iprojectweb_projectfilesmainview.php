 ...
 * @file
 *
 * 	iProjectWebProjectFiles main view html template
 *
...
echo iProjectWebUtils::getViewDescriptionLabel(IPROJECTWEB_ProjectFiles);
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_projectfilesmainviewrow.php',
          'getProjectFilesMainViewRow',
          $viewmap
        );?>
      </table>
    </div>
