 ...
 * @file
 *
 * 	iProjectWebProjectField2 main form html template
 *
 * 	@see iProjectWebProjectField2::getMainForm()
 */
...
echo iProjectWebUtils::getTypeFormDescription($obj->getId(), 'ProjectField2');
