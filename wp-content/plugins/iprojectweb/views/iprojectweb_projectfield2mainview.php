 ...
 * @file
 *
 * 	iProjectWebProjectField2 main view html template
 *
...
?>
  ...
  <div>
    <div id='divProjectField2Filter' class='ufo-filter'>
    ...
    <div class='viewtable'>
      <table class='vtable'>
        ...
        <?php iProjectWebLayout::getRows(
          ...
          $obj,
          'iprojectweb_projectfield2mainviewrow.php',
          'getProjectField2MainViewRow',
          $viewmap
        );?>
      </table>
    </div>
